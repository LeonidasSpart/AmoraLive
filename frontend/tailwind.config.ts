  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'amora-gradient': 'linear-gradient(135deg, #ec4899 0%, #db2777 50%, #be185d 100%)',
        'amora-gradient-light': 'linear-gradient(135deg, #fdf2f8 0%, #fce7f3 50%, #fbcfe8 100%)',
        'gold-gradient': 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 50%, #d97706 100%)',
        'dark-gradient': 'linear-gradient(180deg, #0f172a 0%, #1e293b 100%)',
      },
      boxShadow: {
        'amora': '0 4px 14px 0 rgba(236, 72, 153, 0.39)',
        'amora-lg': '0 10px 40px -10px rgba(236, 72, 153, 0.5)',
