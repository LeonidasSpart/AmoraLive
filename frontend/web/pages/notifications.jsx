...
const s = {
  ...
  markAllBtn: { background: 'transparent', border: '1px solid #FF6B9D', color: 'linear-gradient(135deg, #ff3f9d 0%, #ff5da8 35%, #9b35ff 100%)', padding: '6px 14px', borderRadius: 16, cursor: 'pointer', fontSize: 13 },
  ...
  itemUnread: { borderColor: 'linear-gradient(135deg, #ff3f9d 0%, #ff5da8 35%, #9b35ff 100%)', background: '#1e1526' },
  icon: { fontSize: 22 },
